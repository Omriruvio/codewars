 ...
 * - Duplicate values for same data parameter will resolve to first input.
 * @param messageBody String containing user sent crop data
 * @returns temperature, humidity, ph, ec
 */

const parseCropData = (messageBody) => {
  const parsed = { temperature: null, humidity: null, ec: null, ph: null };
